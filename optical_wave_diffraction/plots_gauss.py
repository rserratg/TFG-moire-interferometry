...
wave1.angular_spectrum(image_distance(1))
plt.figure()
...
wave2.angular_spectrum(image_distance(1))
...
wave3.angular_spectrum(image_distance(2))
plt.figure()
...
wave5.angular_spectrum(image_distance(3/2))
plt.figure()
