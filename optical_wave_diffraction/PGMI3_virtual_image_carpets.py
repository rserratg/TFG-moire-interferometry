# 3 phase-grating moire interferometer
# Analysis of "virtual/Fourier image" discussed in Miao 2016.

'''
    Carpets after virtual images ('echo' plane) of the 3 PGMI
    ...
    Note:
      - This script intends to compare the carpets after the virtual image and after
        a single grating, as well as the moire fringes caused by the image and a grating
        with those caused by the 2pgmi. 
      - If the pattern at the echo plane is a virtual image, the results should be similar.
      - Conlcusion reached is that no such thing as a virtual image exists, it is just an 
        approximation.
'''
